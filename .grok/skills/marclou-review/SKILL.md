...
name: marclou-review
description: >
  Review a landing page, product site, or SaaS marketing surface against Marc Lou–style
  “viral product” principles (hero, CTA, pricing, copy, OG, paywall, proof). Use when the
  user asks for marclou-review, Marc Lou review, viral landing review, conversion critique
  of a homepage/hero/pricing, or “review my product like Marc Lou”. Use when running /marclou-review.
---
...
## Application notes for this monorepo (dino.blog)
