/**
 * Snapshot do inventário dino-platform (somente leitura local).
 * Fonte: packages/shared/src/skills-catalog.ts — NÃO acopla ao monorepo platform.
 */
...
export const SOURCE_ORIGINS: Record<string, { label: string; url: string }> = {
  dino: {
    label: "dino",
...
export const CATEGORY_LABELS: Record<SkillCategory | "all", string> = {
  all: "todas",
  developers: "dev",
  designers: "design",
  marketing: "marketing",
